...
class kart{
    ...
    refresh(){
        if(this.pressAccelerate){
            if(Math.abs(this.acceleration)!==this.vMax){
                this.acceleration+=(this.pressAccelerate*0.2-Math.sign(this.acceleration)*0.1)*this.fixLag;
                if(Math.abs(this.acceleration)>this.vMax) this.acceleration=this.vMax*Math.sign(this.acceleration);
            }
        }else{
            this.acceleration-=(Math.sign(this.acceleration)*0.1)*this.fixLag;
        ...
        if(this.drift && this.vitesse){
            ...
            if(this.pressTurn){
                ...
                if(devmod) this.rotate+=(this.pressTurn*2)*this.fixLag;
